...
- Notice: here I did all queries and I used python(pandas package) for exploring, you can also use Ecxel, and you will see that my csv files data is about my city Benghazi so you can choose any city from given database from Udacity.
